"""Semi-implicit treatment of gravity waves in the shallow water equations.
...
The IMEX (Implicit-Explicit) leapfrog scheme cleanly separates the tendency
into explicit nonlinear terms and implicit linear gravity-wave terms:
